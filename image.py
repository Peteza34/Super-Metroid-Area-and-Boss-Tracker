...
#pathStringsList = 2d list of image paths
def imageList(pathStringsList):
    return [pygame.image.load(os.path.join(*pathStrings)).convert_alpha() for pathStrings in pathStringsList]
...
#Dims image by adding some amount of black to the image.
...
#increases the rbg value of each non-transparent pixel by a set amount
